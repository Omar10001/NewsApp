...
function Home() {
  ...
  return (
    <div className="w-full ">
      <div className="bg-[#010100]/30 backdrop-blur-md w-[368px]  md:w-[440px] fixed z-20 top-0 py-7 px-4  text-[#d7d8db] flex md:justify-center items-center  ">
      ...
      <div className="w-full h-full flex pt-20 items-center justify-center ">
        {result.length > 0 ? (
          ...
          <div className="h-full w-full mr-10 md:mr-0 md:ml-5 ml-0  md:w-96 min-h-screen flex justify-center items-center pl-4 ">
